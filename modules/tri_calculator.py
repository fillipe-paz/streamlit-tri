...
def classify_ability(theta: float) -> Tuple[str, str]:
    """
    Classifica a habilidade θ em categorias descritivas.
    ...
    """
    if theta < -1.5:
        return ("Muito Baixo", "Habilidade significativamente abaixo da média")
    elif theta < -0.5:
        return ("Baixo", "Habilidade abaixo da média")
    elif theta < 0.5:
        return ("Médio", "Habilidade na média")
    elif theta < 1.5:
        return ("Alto", "Habilidade acima da média")
    else:
        return ("Muito Alto", "Habilidade significativamente acima da média")
